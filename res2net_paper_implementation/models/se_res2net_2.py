    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, 16, 3, 1, 1, bias=False),  # <-- For 52K params model
            nn.BatchNorm2d(16),
            nn.ReLU(inplace=True),
        ...
        # self.conv1 = nn.Sequential(nn.Conv2d(1, 16, 3, 1, 1, bias=False),  #<-- For 52K params model
...
def se_res2net50_2(**kwargs):
    """Constructs a Res2Net-50_v1b model.
    Res2Net-50 refers to the Res2Net-50_v1b_26w_4s.
    """
    model = Res2Net(SEBottle2neck, [3, 4, 6], baseWidth=26, scale=4, **kwargs)
    return model
